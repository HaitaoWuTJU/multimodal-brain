...
cp -r /root/workspace/wht/multimodal_brain/datasets/things-eeg-small/Image_set /dev/shm/wht/datasets/things-eeg-small/

cp /root/workspace/wht/multimodal_brain/datasets/things-eeg-small/Preprocessed_data_250Hz_whiten/*.pt /dev/shm/wht/datasets/things-eeg-small/Preprocessed_data_250Hz_whiten/