...
if __name__=='__main__':
    ...
    test_dataset = ThingsDataset(data_root='/root/workspace/wht/multimodal_brain/datasets/things-eeg-small/Image_set',mode='train')
    classes = test_dataset.classes
    class_descriptions = [f"This is a {cls}." for cls in classes] 
    text_tokens = open_clip.tokenize(class_descriptions).to(device)
    test_dataloader = DataLoader(test_dataset, batch_size=128, shuffle=False)  # Adjust batch_size according to your needs
    results = []
