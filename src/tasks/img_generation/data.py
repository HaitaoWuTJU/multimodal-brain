...
def load_data(config):
    ...
    test_dataset = EEGDataset(data_dir=data_config['data_dir'],subjects=data_config['subjects'],model_type=data_config['clip_feature'],mode='test',selected_ch=data_config['selected_ch'],transform=None,avg=True)
    ...
    train_loader = DataLoader(train_dataset, batch_size=data_config['batch_size'], shuffle=True, drop_last=False, num_workers=12, pin_memory=True)
