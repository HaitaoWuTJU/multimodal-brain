...
project_dir = '/home/wht/multimodal_brain/datasets/things-eeg-small'
...
# 'label': label,
img_directory = f'/home/wht/multimodal_brain/datasets/things-eeg-small/Image_set/test_images'
...
img_directory = f'/home/wht/multimodal_brain/datasets/things-eeg-small/Image_set/train_images'
all_folders = [d for d in os.listdir(img_directory) if os.path.isdir(os.path.join(img_directory, d))]
all_folders.sort()
images = []  
labels = []
