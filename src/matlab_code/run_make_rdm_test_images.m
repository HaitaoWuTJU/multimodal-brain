function run_make_rdm_test_images(varargin)
    ...
    outfn = sprintf('../data/derivatives/RDM/sub-%02i_rdm_test_images.mat',subjectnr);
    fprintf('loading %s\n',fn);tic
    load(fn,'ds')
    fprintf('loading data finished in %i seconds\n',ceil(toc))
    ds = cosmo_slice(ds,ds.sa.isteststim>0,1);
